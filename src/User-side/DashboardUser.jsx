...
export default function Dashboard() {
  ...
  // Load logged‑in user stored in Loginpage.jsx
  useEffect(() => {
    const stored = sessionStorage.getItem("user");
    if (stored) {
      try {
        const user = JSON.parse(stored);
        setCurrentUser(user); // keep full object, must include employeeId
  ...
  // Heartbeat: mark this employee online/offline
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-green-50 text-green-900">
      ...
      <header className="bg-white shadow-sm">
        <nav className="max-w-6xl mx-auto flex justify-between items-center px-2 sm:px-4 md:px-6 py-3 sm:py-4">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-xs sm:text-sm min-w-[400px]">
                ...
                <tbody>
                  <tr>
                    <td>Basic Pay</td>
                    <td className="whitespace-nowrap">₱60,000</td>
                    <td className="whitespace-nowrap">₱12,000</td>
                    <td className="whitespace-nowrap">₱48,000</td>
                  </tr>
                  <tr>
                    <td>Bonus</td>
                    <td className="whitespace-nowrap">₱5,000</td>
                    <td>-</td>
                    <td className="whitespace-nowrap">₱5,000</td>
                  </tr>
                  <tr className="font-semibold border-t">
                    ...
                    <td className="pt-2 whitespace-nowrap">₱53,000</td>
                  </tr>
                </tbody>
              </table>
            </div>
