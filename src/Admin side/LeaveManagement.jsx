...
export default function LeaveManagement() {
  ...
  const formAnim =
    activeTab !== null
      ? "transition-all duration-500 ease-in-out max-h-[2000px] opacity-100 scale-100"
      : "transition-all duration-500 ease-in-out max-h-0 opacity-0 scale-95";
      ...
      <main className="flex-1 p-8 overflow-y-auto overflow-x-hidden bg-white">
        ...
        <div className="flex justify-center gap-8 mb-6">
          <button
            ...
            className={`px-10 py-3 rounded-lg cursor-pointer shadow-md ${btnAnim[0]} ${
              activeTab === "settings"
          ...
          <button
            ...
            className={`px-10 py-3 rounded-lg cursor-pointer shadow-md ${btnAnim[1]} ${
              activeTab === "recall"
                ? "bg-yellow-400 text-green-900 font-bold"
                : "bg-green-700 text-white hover:bg-yellow-400 hover:text-green-900"
            }`}
          ...
          <button
            ...
            className={`px-10 py-3 rounded-lg cursor-pointer shadow-md ${btnAnim[2]} ${
              activeTab === "history"
                ? "bg-yellow-400 text-green-900 font-bold"
                : "bg-green-700 text-white hover:bg-yellow-400 hover:text-green-900"
            }`}
        ...
        {/* Animated Forms */}
        <div className={formAnim}>
          {/* Leave Settings Panel */}
          {activeTab === "settings" && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Create Settings */}
              <div className="p-6 bg-white rounded-2xl shadow-md">
                <h2 className="text-lg font-semibold underline mb-4 text-green-800">
                ...
                <form className="space-y-3">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full p-2 bg-yellow-50 rounded-md border border-yellow-200"
                      />
                    </div>
                    <div>
                      <label className="text-sm text-green-800 font-semibold">
                  ...
                  <button
                    type="button"
                    className="w-full bg-green-700 text-white cursor-pointer py-2 rounded-md hover:bg-yellow-400 hover:text-green-900 font-bold"
                  >
                    Create
                  </button>
                </form>
                          ...
                          <td className="relative p-3">
                            ...
                            {openDropdown === index && (
                              <div className="absolute z-50 mt-2 w-28 bg-yellow-400 border border-yellow-200 rounded-md shadow-lg">
                                <button className="block w-full text-left px-3 py-2 cursor-pointer hover:bg-yellow-100 text-sm">
                                  Edit
                                </button>
                                <button className="block w-full text-left px-3 py-2 cursor-pointer hover:bg-yellow-100 text-sm text-red-600">
                                  Delete
                                </button>
                              </div>
                            )}
