    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      >
        <div>
          ...
          <div className="px-4">
            <h3
              className={`text-gray-400 text-xs uppercase mb-2 ${
                !isOpen && 'hidden'
              }`}
            >
              Features
            ...
            {/* Organization */}
            <h3
              className={`text-gray-400 text-xs uppercase mt-6 mb-2 ${
                !isOpen && 'hidden'
              }`}
            >
              Organization
      ...
      <main className="flex-1 p-8 overflow-x-hidden">
        ...
        <div className="flex overflow-x-auto gap-6 pb-6 no-scrollbar">
         {/* Messages */}
         <div className="flex-1 min-w-[250px] bg-green-700 text-white rounded-2xl p-8 flex items-center justify-between ">
          <Mail size={60} />
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
  {/* Applied Jobs */}
  <div className="bg-[#E9F1FA] rounded-2xl shadow-md p-6">
